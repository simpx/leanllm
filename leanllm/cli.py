...
def main():
    parser = argparse.ArgumentParser(description="LeanLLM: Lightweight LLM inference")
    parser.add_argument("--model", default="openai-community/gpt2", help="Model ID from HuggingFace")
